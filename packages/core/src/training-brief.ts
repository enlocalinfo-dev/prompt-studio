...
export function buildTrainingBriefTranscript(
  ...
  const blocks = [
    ...
    "【入力ルール】人数・部署は「研修対象者」欄だけを使う。型紙見本の人数・部署は、見積に無い限り使わない。",
    "【入力ルール】回数・各回テーマは「見積書より（スライド2と3）」欄だけを使う。型紙見本の回数・各回テーマは、見積に無い限り使わない。",
    "【入力ルール】見積に群1・群2がある場合は群ごとに対象・講座・回数・日程を分ける。実施カレンダーの通し番号を、全員が連続受講する1本の全回と解釈しない。図解は群ごとのレーン。横一列の連続フローは禁止。",
    "",
    "【研修対象者】（スライド2・①）",
